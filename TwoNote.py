...
class MainWindow(Gtk.ApplicationWindow):
	def __init__(self):
		...
		self.menu.append_item(self.new_item)
		self.menu.append_item(self.new_book_item)
		self.menu.append_item(self.open_item)
		self.menu.append_item(self.save_item)
		self.menu.append_item(self.save_as_item)
		self.menu.append_item(self.settings_item)
