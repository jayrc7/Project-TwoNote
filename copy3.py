   ...
   def __init__(self):
    ...
    #  menuButton = Gtk.MenuButton()
     ...
     # menu.append("Click", "win.click_here")
      ...
      self.button_bold.connect("clicked", self.on_button_clicked, self.tag_bold)
...
window.add_events(Gdk.EventType.BUTTON_PRESS)
window.connect('button-press-event', window.mouse_clicked)
window.show_all()
Gtk.main()
